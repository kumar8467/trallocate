        ...
        <div className="col-sm-8 col-sm-offset-2">
          <form className={this.props.className} id={this.props.id} onSubmit={this._onClick}>
            <div className={"form-group"}>
              ...
              <InputField id="username" className={"form-control"} placeholder="username" type="text" name="username"
                          autofocus={"autofocus"}/>
            </div>
            <div className="form-group">
              <label className={"control-label"}>Password</label>
              <InputField id="password" className={"form-control"} placeholder="password" type="password"
                          name="password" autofocus={"autofocus"}/>
            </div>
            <InputButton id="login-btn" className="btn btn-primary" value="Sign in"/>
          </form>
          <div classNam="oauth">
